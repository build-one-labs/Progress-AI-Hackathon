...
export const NON_STRING_FIELDS = new Set([
  // Decimal / Double / Int
  'AMOUNT', 'PROBABILITY', 'EXPECTEDREVENUE', 'TOTALOPPORTUNITYQUANTITY', 'REFERENCE_NUMBER__C',
  'PUSHCOUNT', 'FISCALQUARTER', 'FISCALYEAR',
  // Boolean
  'ISDELETED', 'ISPRIVATE', 'ISCLOSED', 'ISWON',
  'HASOPPORTUNITYLINEITEM', 'HASOPENACTIVITY', 'HASOVERDUETASK',
  // Date / DateTimeOffset
  'CLOSEDATE', 'LASTACTIVITYDATE', 'LASTSTAGECHANGEDATE',
