...
- **Architecture & DevOps**: `architecture_info/AGENTS.md` - Full framework architecture, CLI commands, deployment, CircleCI, git workflow, testing
- **Blueprint DSL**: `blueprint_dsl/AGENTS.md` - UI generation, screens, layouts, menus, rendering engine
- **Skills**: `skills/AGENTS.md` - Multi-step workflows (Portainer deployment, schema generation)
...
- `CLAUDE_ORG_UUID` - Codex organization UUID
